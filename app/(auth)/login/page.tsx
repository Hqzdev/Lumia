  ...
  return (
    <TooltipProvider>
      <div className="relative flex h-dvh w-screen flex-col items-center justify-center overflow-hidden bg-[#fafafa]">
        <div className="absolute left-4 top-4 text-2xl font-bold select-none hidden sm:block">
          Lumia
        </div>
        <div className="z-10 w-full max-w-md flex flex-col items-center justify-center gap-4">
          <h1 className="text-3xl font-semibold text-center mt-1 mb-1">
            {showPassword && isNicknameLocked
              ? 'Enter your password'
              : 'Welcome back'}
          </h1>
          <div className="text-gray-500 text-base font-medium text-center mb-2 leading-relaxed">
          ...
          <div className="w-full flex flex-row justify-center gap-1 mt-4 text-xs text-gray-500 items-center">
            <Link
              href="/policy"
