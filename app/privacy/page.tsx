          ...
          <section id="acceptance">
            ...
            <div className="prose prose-gray max-w-none">
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                agreement between you and LumiaAi ("we," "us," or "our")
                regarding your use of our artificial intelligence chatbot
          ...
          <section id="content">
            ...
            <div className="prose prose-gray max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                ("User Content"). By using the Service, you grant us a limited
                license to:
              </p>
              <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                ("Generated Content") is provided to you under a permissive
                license. You may use Generated Content for any lawful purpose,
